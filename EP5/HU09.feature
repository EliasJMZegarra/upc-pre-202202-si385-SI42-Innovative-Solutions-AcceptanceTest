Feature: HU09: Comunicación directa mediante mensajería dentro de la aplicación

Como vecino 
quiero poder comunicarme con el administrador de una manera rápida 
...
Dado que un vecino quiere informar sobre algún reclamo a los directivos del condominio
