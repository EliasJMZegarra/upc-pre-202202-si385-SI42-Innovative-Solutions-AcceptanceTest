Feature: HU08: Cobro por pago de servicios y gastos administrativos

Como administrador/vecino de condominio 
quiero poder realizar el cobro/pago de los servicios y gastos administrativos 
para poder facilitar la recaudación de los pagos.

Escenario: Un vecino realiza el pago de los servicios administrativos

Dado que un usuario vecino quiere realizar el pago de los servicios administrativos
